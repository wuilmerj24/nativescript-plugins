    ...
    export module glide {
      ...
      export module ListPreloader {
        ...
        export class PreloadSizeProvider<T> extends java.lang.Object {
           ...
           */
          public constructor(implementation: { getPreloadSize(param0: T, param1: number, param2: number): androidNative.Array<number> });
          public constructor();
  ...
  export module bumptech {
    export module glide {
      export class ModelTypes<T> extends java.lang.Object {
         ...
         */
        public constructor(implementation: { load(param0: globalAndroid.graphics.Bitmap): T; load(param0: globalAndroid.graphics.drawable.Drawable): T; load(param0: string): T; load(param0: globalAndroid.net.Uri): T; load(param0: java.io.File): T; load(param0: java.lang.Integer): T; load(param0: java.net.URL): T; load(param0: androidNative.Array<number>): T; load(param0: any): T });
        public constructor();
  ...
  export module bumptech {
    export module glide {
      export class Registry {
        ...
        public static BUCKET_ANIMATION: string = 'Animation';
        public static BUCKET_GIF: string = 'Animation';
        public static BUCKET_BITMAP: string = 'Bitmap';
        public static BUCKET_BITMAP_DRAWABLE: string = 'BitmapDrawable';
    ...
    export module glide {
      export module load {
        export class ImageHeaderParser {
          ...
          public constructor();
          public static UNKNOWN_ORIENTATION: number = -1;
      ...
      export module load {
        ...
        export module ImageHeaderParserUtils {
          export class OrientationReader {
             ...
             */
            public constructor(implementation: { getOrientationAndRewind(param0: com.bumptech.glide.load.ImageHeaderParser): number });
            public constructor();
          ...
          export class TypeReader {
             ...
             */
            public constructor(implementation: { getTypeAndRewind(param0: com.bumptech.glide.load.ImageHeaderParser): com.bumptech.glide.load.ImageHeaderParser.ImageType });
            public constructor();
    ...
    export module glide {
      export module load {
        export class Key {
          ...
          public constructor();
          public static STRING_CHARSET_NAME: string = 'UTF-8';
      ...
      export module load {
        ...
        export module Option {
          export class CacheKeyUpdater<T> extends java.lang.Object {
             ...
             */
            public constructor(implementation: { update(param0: androidNative.Array<number>, param1: T, param2: java.security.MessageDigest): void });
            public constructor();
      ...
      export module load {
        export module data {
          export class ExifOrientationStream {
            ...
            public read(read: androidNative.Array<number>, read: number, this_: number): number;
        ...
        export module engine {
          ...
          export module DecodeJob {
            export class Callback<R> extends java.lang.Object {
               ...
               */
              public constructor(implementation: { onResourceReady(param0: com.bumptech.glide.load.engine.Resource<R>, param1: com.bumptech.glide.load.DataSource, param2: boolean): void; onLoadFailed(param0: com.bumptech.glide.load.engine.GlideException): void; reschedule(param0: com.bumptech.glide.load.engine.DecodeJob<any>): void });
              public constructor();
        ...
        export module engine {
          export module bitmap_recycle {
            export class ArrayPool {
               ...
               */
              public constructor(implementation: { put(param0: any, param1: java.lang.Class<any>): void; put(param0: any): void; get(param0: number, param1: java.lang.Class<any>): any; getExact(param0: number, param1: java.lang.Class<any>): any; clearMemory(): void; trimMemory(param0: number): void });
              public constructor();
              public static STANDARD_BUFFER_SIZE_BYTES: number = 65536;
          ...
          export module cache {
            ...
            export module DiskCache {
              export class Factory {
                ...
                public constructor();
                public static DEFAULT_DISK_CACHE_DIR: string = 'image_manager_disk_cache';
                public static DEFAULT_DISK_CACHE_SIZE: number = 262144000;
          ...
          export module executor {
            ...
            export module GlideExecutor {
              export class Builder {
                ...
                public static NO_THREAD_TIMEOUT: number = 0;
        ...
        export module model {
          ...
          export module ByteArrayLoader {
            ...
            export class Converter<Data> extends java.lang.Object {
               ...
               */
              public constructor(implementation: { convert(param0: androidNative.Array<number>): Data; getDataClass(): java.lang.Class<Data> });
              public constructor();
          ...
          export module bitmap {
            ...
            export module DefaultImageHeaderParser {
              ...
              export class Reader {
                 ...
                 */
                public constructor(implementation: { getUInt8(): number; getUInt16(): number; read(param0: androidNative.Array<number>, param1: number): number; skip(param0: number): number });
                public constructor();
                public skip(param0: number): number;
                public getUInt8(): number;
                public getUInt16(): number;
        ...
        export module resource {
          export module bitmap {
            export class HardwareConfigState {
              ...
              public static NO_MAX_FD_COUNT: number = -1;
        ...
        export module resource {
          export module bitmap {
            export class RecyclableBufferedInputStream {
              ...
              public read(): number;
              public read(required: androidNative.Array<number>, read: number, read: number): number;
              public release(): void;
              public reset(): void;
            }
        ...
        export module resource {
          export module bitmap {
            export class TransformationUtils {
              ...
              public static PAINT_FLAGS: number = 6;
        ...
        export module resource {
          export module bitmap {
            export class VideoDecoder<T> extends com.bumptech.glide.load.ResourceDecoder<any, globalAndroid.graphics.Bitmap> {
              ...
              public static DEFAULT_FRAME: number = -1;
            ...
            export module VideoDecoder {
              export class AssetFileDescriptorInitializer extends com.bumptech.glide.load.resource.bitmap.VideoDecoder.MediaInitializer<globalAndroid.content.res.AssetFileDescriptor> {
                ...
                public initializeRetriever(retriever: globalAndroid.media.MediaMetadataRetriever, data: globalAndroid.content.res.AssetFileDescriptor): void;
              ...
              export class ByteBufferInitializer extends com.bumptech.glide.load.resource.bitmap.VideoDecoder.MediaInitializer<java.nio.ByteBuffer> {
                ...
                public initializeRetriever(retriever: globalAndroid.media.MediaMetadataRetriever, data: java.nio.ByteBuffer): void;
                public initializeExtractor(param0: globalAndroid.media.MediaExtractor, param1: any): void;
              }
              ...
              export class ParcelFileDescriptorInitializer extends com.bumptech.glide.load.resource.bitmap.VideoDecoder.MediaInitializer<globalAndroid.os.ParcelFileDescriptor> {
                ...
                public initializeRetriever(param0: globalAndroid.media.MediaMetadataRetriever, param1: any): void;
                public initializeRetriever(retriever: globalAndroid.media.MediaMetadataRetriever, data: globalAndroid.os.ParcelFileDescriptor): void;
        ...
        export module resource {
          export module gif {
            export class GifDrawable implements com.bumptech.glide.load.resource.gif.GifFrameLoader.FrameCallback {
              ...
              public static LOOP_FOREVER: number = -1;
              public static LOOP_INTRINSIC: number = 0;
    ...
    export module glide {
      export module manager {
        export class FrameWaiter {
           ...
           */
          public constructor(implementation: { registerSelf(param0: globalAndroid.app.Activity): void });
          public constructor();
          public registerSelf(param0: globalAndroid.app.Activity): void;
        }
      }
      ...
      export module manager {
        ...
        export module SingletonConnectivityReceiver {
          export class FrameworkConnectivityMonitor {
             ...
             */
            public constructor(implementation: { register(): boolean; unregister(): void });
            public constructor();
    ...
    export module glide {
      export module request {
        export class FutureTarget<R> extends java.lang.Object {
           ...
           */
          public constructor(implementation: { onLoadStarted(param0: globalAndroid.graphics.drawable.Drawable): void; onLoadFailed(param0: globalAndroid.graphics.drawable.Drawable): void; onResourceReady(param0: R, param1: com.bumptech.glide.request.transition.Transition<any>): void; onLoadCleared(param0: globalAndroid.graphics.drawable.Drawable): void; getSize(param0: com.bumptech.glide.request.target.SizeReadyCallback): void; removeCallback(param0: com.bumptech.glide.request.target.SizeReadyCallback): void; setRequest(param0: com.bumptech.glide.request.Request): void; getRequest(): com.bumptech.glide.request.Request; onStart(): void; onStop(): void; onDestroy(): void });
          public constructor();
          public static SIZE_ORIGINAL: number = -2147483648;
          public onStart(): void;
          public getRequest(): com.bumptech.glide.request.Request;
          public setRequest(param0: com.bumptech.glide.request.Request): void;
          public onLoadStarted(param0: globalAndroid.graphics.drawable.Drawable): void;
    ...
    export module glide {
      export module request {
        export class ResourceCallback {
           ...
           */
          public constructor(implementation: { onResourceReady(param0: com.bumptech.glide.load.engine.Resource<any>, param1: com.bumptech.glide.load.DataSource, param2: boolean): void; onLoadFailed(param0: com.bumptech.glide.load.engine.GlideException): void; getLock(): any });
          public constructor();
      ...
      export module request {
        export module target {
          export class Target<R> extends com.bumptech.glide.manager.LifecycleListener {
             ...
             */
            public constructor(implementation: { onLoadStarted(param0: globalAndroid.graphics.drawable.Drawable): void; onLoadFailed(param0: globalAndroid.graphics.drawable.Drawable): void; onResourceReady(param0: any, param1: com.bumptech.glide.request.transition.Transition<any>): void; onLoadCleared(param0: globalAndroid.graphics.drawable.Drawable): void; getSize(param0: com.bumptech.glide.request.target.SizeReadyCallback): void; removeCallback(param0: com.bumptech.glide.request.target.SizeReadyCallback): void; setRequest(param0: com.bumptech.glide.request.Request): void; getRequest(): com.bumptech.glide.request.Request; onStart(): void; onStop(): void; onDestroy(): void });
            public constructor();
            public static SIZE_ORIGINAL: number = -2147483648;
            public onDestroy(): void;
            public onResourceReady(param0: any, param1: com.bumptech.glide.request.transition.Transition<any>): void;
