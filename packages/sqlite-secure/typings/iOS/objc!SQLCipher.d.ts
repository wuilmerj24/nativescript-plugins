...
declare var SQLCipherVersionNumber: number;

declare var SQLCipherVersionString: interop.Reference<number>;

declare function sqlite3_activate_see(zPassPhrase: string | interop.Pointer | interop.Reference<any>): void;
...
declare function sqlite3_autovacuum_pages(db: interop.Pointer | interop.Reference<any>, p2: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<any>, p2: interop.Pointer | interop.Reference<any>, p3: number, p4: number, p5: number) => number>, p3: interop.Pointer | interop.Reference<any>, p4: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<any>) => void>): number;
...
declare function sqlite3_bind_parameter_name(p1: interop.Pointer | interop.Reference<any>, p2: number): interop.Pointer | interop.Reference<any>;
...
declare function sqlite3_collation_needed(p1: interop.Pointer | interop.Reference<any>, p2: interop.Pointer | interop.Reference<any>, p3: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<any>, p2: interop.Pointer | interop.Reference<any>, p3: number, p4: interop.Pointer | interop.Reference<any>) => void>): number;
...
declare function sqlite3_column_database_name(p1: interop.Pointer | interop.Reference<any>, p2: number): interop.Pointer | interop.Reference<any>;
...
declare function sqlite3_column_decltype(p1: interop.Pointer | interop.Reference<any>, p2: number): interop.Pointer | interop.Reference<any>;
...
declare function sqlite3_column_name(p1: interop.Pointer | interop.Reference<any>, N: number): interop.Pointer | interop.Reference<any>;
...
declare function sqlite3_column_origin_name(p1: interop.Pointer | interop.Reference<any>, p2: number): interop.Pointer | interop.Reference<any>;
...
declare function sqlite3_column_table_name(p1: interop.Pointer | interop.Reference<any>, p2: number): interop.Pointer | interop.Reference<any>;
...
declare function sqlite3_column_text(p1: interop.Pointer | interop.Reference<any>, iCol: number): interop.Pointer | interop.Reference<any>;
...
declare function sqlite3_compileoption_get(N: number): interop.Pointer | interop.Reference<any>;
...
declare function sqlite3_create_filename(zDatabase: string | interop.Pointer | interop.Reference<any>, zJournal: string | interop.Pointer | interop.Reference<any>, zWal: string | interop.Pointer | interop.Reference<any>, nParam: number, azParam: interop.Pointer | interop.Reference<interop.Pointer | interop.Reference<any>>): interop.Pointer | interop.Reference<any>;
...
declare var sqlite3_data_directory: interop.Pointer | interop.Reference<any>;
...
declare function sqlite3_db_filename(db: interop.Pointer | interop.Reference<any>, zDbName: string | interop.Pointer | interop.Reference<any>): interop.Pointer | interop.Reference<any>;
...
declare function sqlite3_db_name(db: interop.Pointer | interop.Reference<any>, N: number): interop.Pointer | interop.Reference<any>;
...
declare function sqlite3_drop_modules(db: interop.Pointer | interop.Reference<any>, azKeep: interop.Pointer | interop.Reference<interop.Pointer | interop.Reference<any>>): number;

declare function sqlite3_enable_load_extension(db: interop.Pointer | interop.Reference<any>, onoff: number): number;
...
declare function sqlite3_errmsg(p1: interop.Pointer | interop.Reference<any>): interop.Pointer | interop.Reference<any>;
...
declare function sqlite3_errstr(p1: number): interop.Pointer | interop.Reference<any>;

declare function sqlite3_exec(p1: interop.Pointer | interop.Reference<any>, sql: string | interop.Pointer | interop.Reference<any>, callback: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<any>, p2: number, p3: interop.Pointer | interop.Reference<interop.Pointer | interop.Reference<any>>, p4: interop.Pointer | interop.Reference<interop.Pointer | interop.Reference<any>>) => number>, p4: interop.Pointer | interop.Reference<any>, errmsg: interop.Pointer | interop.Reference<interop.Pointer | interop.Reference<any>>): number;

declare function sqlite3_expanded_sql(pStmt: interop.Pointer | interop.Reference<any>): interop.Pointer | interop.Reference<any>;
...
declare function sqlite3_filename_database(p1: string | interop.Pointer | interop.Reference<any>): interop.Pointer | interop.Reference<any>;

declare function sqlite3_filename_journal(p1: string | interop.Pointer | interop.Reference<any>): interop.Pointer | interop.Reference<any>;

declare function sqlite3_filename_wal(p1: string | interop.Pointer | interop.Reference<any>): interop.Pointer | interop.Reference<any>;
...
declare function sqlite3_free_table(result: interop.Pointer | interop.Reference<interop.Pointer | interop.Reference<any>>): void;
...
declare function sqlite3_hard_heap_limit64(N: number): number;
...
interface sqlite3_index_info {
	...
	idxNum: number;
	idxStr: interop.Pointer | interop.Reference<any>;
...
declare function sqlite3_key(db: interop.Pointer | interop.Reference<any>, pKey: interop.Pointer | interop.Reference<any>, nKey: number): number;

declare function sqlite3_key_v2(db: interop.Pointer | interop.Reference<any>, zDbName: string | interop.Pointer | interop.Reference<any>, pKey: interop.Pointer | interop.Reference<any>, nKey: number): number;
...
declare function sqlite3_keyword_name(p1: number, p2: interop.Pointer | interop.Reference<interop.Pointer | interop.Reference<any>>, p3: interop.Pointer | interop.Reference<number>): number;

declare function sqlite3_last_insert_rowid(p1: interop.Pointer | interop.Reference<any>): number;

declare function sqlite3_libversion(): interop.Pointer | interop.Reference<any>;
...
declare function sqlite3_load_extension(db: interop.Pointer | interop.Reference<any>, zFile: string | interop.Pointer | interop.Reference<any>, zProc: string | interop.Pointer | interop.Reference<any>, pzErrMsg: interop.Pointer | interop.Reference<interop.Pointer | interop.Reference<any>>): number;
...
interface sqlite3_module {
	iVersion: number;
	xCreate: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<any>, p2: interop.Pointer | interop.Reference<any>, p3: number, p4: interop.Pointer | interop.Reference<interop.Pointer | interop.Reference<any>>, p5: interop.Pointer | interop.Reference<interop.Pointer | interop.Reference<sqlite3_vtab>>, p6: interop.Pointer | interop.Reference<interop.Pointer | interop.Reference<any>>) => number>;
	...
	xFilter: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<sqlite3_vtab_cursor>, p2: number, p3: interop.Pointer | interop.Reference<any>, p4: number, p5: interop.Pointer | interop.Reference<interop.Pointer | interop.Reference<any>>) => number>;
	...
	xFindFunction: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<sqlite3_vtab>, p2: number, p3: interop.Pointer | interop.Reference<any>, p4: interop.Pointer | interop.Reference<interop.FunctionReference<(p1: interop.Pointer | interop.Reference<any>, p2: number, p3: interop.Pointer | interop.Reference<interop.Pointer | interop.Reference<any>>) => void>>, p5: interop.Pointer | interop.Reference<interop.Pointer | interop.Reference<any>>) => number>;
	xRename: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<sqlite3_vtab>, p2: interop.Pointer | interop.Reference<any>) => number>;
...
declare function sqlite3_mutex_held(p1: interop.Pointer | interop.Reference<any>): number;
...
declare function sqlite3_mutex_notheld(p1: interop.Pointer | interop.Reference<any>): number;
...
declare function sqlite3_prepare(db: interop.Pointer | interop.Reference<any>, zSql: string | interop.Pointer | interop.Reference<any>, nByte: number, ppStmt: interop.Pointer | interop.Reference<interop.Pointer | interop.Reference<any>>, pzTail: interop.Pointer | interop.Reference<interop.Pointer | interop.Reference<any>>): number;
...
declare function sqlite3_prepare_v2(db: interop.Pointer | interop.Reference<any>, zSql: string | interop.Pointer | interop.Reference<any>, nByte: number, ppStmt: interop.Pointer | interop.Reference<interop.Pointer | interop.Reference<any>>, pzTail: interop.Pointer | interop.Reference<interop.Pointer | interop.Reference<any>>): number;

declare function sqlite3_prepare_v3(db: interop.Pointer | interop.Reference<any>, zSql: string | interop.Pointer | interop.Reference<any>, nByte: number, prepFlags: number, ppStmt: interop.Pointer | interop.Reference<interop.Pointer | interop.Reference<any>>, pzTail: interop.Pointer | interop.Reference<interop.Pointer | interop.Reference<any>>): number;

declare function sqlite3_profile(p1: interop.Pointer | interop.Reference<any>, xProfile: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<any>, p2: interop.Pointer | interop.Reference<any>, p3: number) => void>, p3: interop.Pointer | interop.Reference<any>): interop.Pointer | interop.Reference<any>;
...
declare function sqlite3_rekey(db: interop.Pointer | interop.Reference<any>, pKey: interop.Pointer | interop.Reference<any>, nKey: number): number;

declare function sqlite3_rekey_v2(db: interop.Pointer | interop.Reference<any>, zDbName: string | interop.Pointer | interop.Reference<any>, pKey: interop.Pointer | interop.Reference<any>, nKey: number): number;
...
declare function sqlite3_serialize(db: interop.Pointer | interop.Reference<any>, zSchema: string | interop.Pointer | interop.Reference<any>, piSize: interop.Pointer | interop.Reference<number>, mFlags: number): interop.Pointer | interop.Reference<any>;

declare function sqlite3_set_authorizer(p1: interop.Pointer | interop.Reference<any>, xAuth: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<any>, p2: number, p3: interop.Pointer | interop.Reference<any>, p4: interop.Pointer | interop.Reference<any>, p5: interop.Pointer | interop.Reference<any>, p6: interop.Pointer | interop.Reference<any>) => number>, pUserData: interop.Pointer | interop.Reference<any>): number;
...
declare function sqlite3_sourceid(): interop.Pointer | interop.Reference<any>;

declare function sqlite3_sql(pStmt: interop.Pointer | interop.Reference<any>): interop.Pointer | interop.Reference<any>;
...
declare function sqlite3_str_finish(p1: interop.Pointer | interop.Reference<any>): interop.Pointer | interop.Reference<any>;
...
declare function sqlite3_str_value(p1: interop.Pointer | interop.Reference<any>): interop.Pointer | interop.Reference<any>;
...
declare function sqlite3_table_column_metadata(db: interop.Pointer | interop.Reference<any>, zDbName: string | interop.Pointer | interop.Reference<any>, zTableName: string | interop.Pointer | interop.Reference<any>, zColumnName: string | interop.Pointer | interop.Reference<any>, pzDataType: interop.Pointer | interop.Reference<interop.Pointer | interop.Reference<any>>, pzCollSeq: interop.Pointer | interop.Reference<interop.Pointer | interop.Reference<any>>, pNotNull: interop.Pointer | interop.Reference<number>, pPrimaryKey: interop.Pointer | interop.Reference<number>, pAutoinc: interop.Pointer | interop.Reference<number>): number;

declare var sqlite3_temp_directory: interop.Pointer | interop.Reference<any>;
...
declare function sqlite3_trace(p1: interop.Pointer | interop.Reference<any>, xTrace: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<any>, p2: interop.Pointer | interop.Reference<any>) => void>, p3: interop.Pointer | interop.Reference<any>): interop.Pointer | interop.Reference<any>;
...
declare function sqlite3_unlock_notify(pBlocked: interop.Pointer | interop.Reference<any>, xNotify: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<interop.Pointer | interop.Reference<any>>, p2: number) => void>, pNotifyArg: interop.Pointer | interop.Reference<any>): number;

declare function sqlite3_update_hook(p1: interop.Pointer | interop.Reference<any>, p2: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<any>, p2: number, p3: interop.Pointer | interop.Reference<any>, p4: interop.Pointer | interop.Reference<any>, p5: number) => void>, p3: interop.Pointer | interop.Reference<any>): interop.Pointer | interop.Reference<any>;
...
declare function sqlite3_uri_key(z: string | interop.Pointer | interop.Reference<any>, N: number): interop.Pointer | interop.Reference<any>;

declare function sqlite3_uri_parameter(z: string | interop.Pointer | interop.Reference<any>, zParam: string | interop.Pointer | interop.Reference<any>): interop.Pointer | interop.Reference<any>;
...
declare function sqlite3_value_text(p1: interop.Pointer | interop.Reference<any>): interop.Pointer | interop.Reference<any>;
...
interface sqlite3_vfs {
	...
	zName: interop.Pointer | interop.Reference<any>;
	pAppData: interop.Pointer | interop.Reference<any>;
	xOpen: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<sqlite3_vfs>, p2: interop.Pointer | interop.Reference<any>, p3: interop.Pointer | interop.Reference<sqlite3_file>, p4: number, p5: interop.Pointer | interop.Reference<number>) => number>;
	xDelete: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<sqlite3_vfs>, p2: interop.Pointer | interop.Reference<any>, p3: number) => number>;
	xAccess: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<sqlite3_vfs>, p2: interop.Pointer | interop.Reference<any>, p3: number, p4: interop.Pointer | interop.Reference<number>) => number>;
	xFullPathname: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<sqlite3_vfs>, p2: interop.Pointer | interop.Reference<any>, p3: number, p4: interop.Pointer | interop.Reference<any>) => number>;
	xDlOpen: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<sqlite3_vfs>, p2: interop.Pointer | interop.Reference<any>) => interop.Pointer | interop.Reference<any>>;
	xDlError: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<sqlite3_vfs>, p2: number, p3: interop.Pointer | interop.Reference<any>) => void>;
	xDlSym: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<sqlite3_vfs>, p2: interop.Pointer | interop.Reference<any>, p3: interop.Pointer | interop.Reference<any>) => interop.FunctionReference<() => void>>;
	...
	xRandomness: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<sqlite3_vfs>, p2: number, p3: interop.Pointer | interop.Reference<any>) => number>;
	...
	xGetLastError: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<sqlite3_vfs>, p2: number, p3: interop.Pointer | interop.Reference<any>) => number>;
	...
	xSetSystemCall: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<sqlite3_vfs>, p2: interop.Pointer | interop.Reference<any>, p3: interop.FunctionReference<() => void>) => number>;
	xGetSystemCall: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<sqlite3_vfs>, p2: interop.Pointer | interop.Reference<any>) => interop.FunctionReference<() => void>>;
	xNextSystemCall: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<sqlite3_vfs>, p2: interop.Pointer | interop.Reference<any>) => interop.Pointer | interop.Reference<any>>;
}
...
interface sqlite3_vtab {
	...
	nRef: number;
	zErrMsg: interop.Pointer | interop.Reference<any>;
}
declare var sqlite3_vtab: interop.StructType<sqlite3_vtab>;

declare function sqlite3_vtab_collation(p1: interop.Pointer | interop.Reference<sqlite3_index_info>, p2: number): interop.Pointer | interop.Reference<any>;
...
declare function sqlite3_wal_hook(p1: interop.Pointer | interop.Reference<any>, p2: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<any>, p2: interop.Pointer | interop.Reference<any>, p3: interop.Pointer | interop.Reference<any>, p4: number) => number>, p3: interop.Pointer | interop.Reference<any>): interop.Pointer | interop.Reference<any>;

declare function sqlite3_win32_set_directory(type: number, zValue: interop.Pointer | interop.Reference<any>): number;

declare function sqlite3_win32_set_directory16(type: number, zValue: interop.Pointer | interop.Reference<any>): number;

declare function sqlite3_win32_set_directory8(type: number, zValue: string | interop.Pointer | interop.Reference<any>): number;
